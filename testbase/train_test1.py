...
from UNetFormer_baseline import UNetFormer as MFNet
...
def train(net, optimizer, epochs, scheduler=None, weights=WEIGHTS, save_epoch=1):
    ...
    align_lambda_max = 0.1
    align_lambda_min = 0.01  # 保留一点点约束
    for e in range(1, epochs + 1):
        ...
        progress = (e - 1) / epochs
        current_lambda = align_lambda_min + 0.5 * (align_lambda_max - align_lambda_min) * (1 + math.cos(math.pi * progress))

...
from UNetFormer_test9 import UNetFormer as MFNet
...
set_seed(SEED)
# 新增：TensorBoard 日志
writer = SummaryWriter(log_dir="./runs/unetformer_test9")

net = MFNet(num_classes=N_CLASSES, dinov3_model_name="/home/csf1/modelscope/models/facebook/dinov3-vitl16-pretrain-lvd1689m").cuda()
        ...
        if e % save_epoch == 0:
            ...
            if MIoU > MIoU_best:
                if DATASET == 'Vaihingen':
                    torch.save(net.state_dict(), './resultsv_test9/{}_epoch{}_{}'.format(MODEL, e, MIoU))

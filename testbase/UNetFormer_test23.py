...
from models.decoder.UPernet import UPerHead
...
class UNetFormer(nn.Module):
    ...
    def forward(self, x, y, mode='Train'):
        ...
        # UPerHead 输出尺寸通常是 feature map 尺寸 (1/4)，需上采样回原图
        out = F.interpolate(out, size=(x.size(-2), x.size(-1)), mode='bilinear', align_corners=False)

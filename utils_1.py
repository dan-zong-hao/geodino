...
FOLDER = "/home/csf1/Documents/dataset/seg/" # Replace with your "/path/to/the/ISPRS/dataset/folder/"
BATCH_SIZE = 10
...
if DATASET == 'Vaihingen':
    ...
    DSM_FOLDER = MAIN_FOLDER + 'sar_png/{}.png'
...
def save_img(tensor, name):
    # tensor = tensor.cpu() .permute((0, 1, 2))
...
if __name__ == "__main__":
    ...
    for idx, (a,b,c) in enumerate(train_set):
        # print((a,b,c))
        save_img(a, f"./save/{idx}rgb")
        save_img(b, f"./save/{idx}dsm")
        # save_img(c, f"./save/{idx}true")
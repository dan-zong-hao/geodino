...
from UNetFormer_test14 import UNetFormer as MFNet
...
set_seed(SEED)
# 新增：TensorBoard 日志
writer = SummaryWriter(log_dir="./runs/unetformer_test14")
        ...
        if e % save_epoch == 0:
            ...
            if MIoU > MIoU_best:
                if DATASET == 'Vaihingen':
                    torch.save(net.state_dict(), './resultsv_test14/{}_epoch{}_{}'.format(MODEL, e, MIoU))

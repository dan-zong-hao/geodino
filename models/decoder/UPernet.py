...
class UPerHead(nn.Module):
    ...
    def __init__(self, in_channels=[96, 192, 384, 768], num_classes=40, channels=512, 
                 pool_scales=(1, 2, 3, 6), norm_layer=nn.BatchNorm2d, dropout_ratio=0.1, align_corners=False):
        super(UPerHead, self).__init__()
        self.in_channels = in_channels
        self.channels = channels
        self.align_corners = align_corners
        
        # PSP Module (Applied on the last feature)
    ...
    def forward(self, inputs):
        ...
        for i in range(used_backbone_levels - 1, 0, -1):
            ...
            # [修复] 改为非原位加法： laterals[i-1] = laterals[i-1] + ...
